...
class FormMeta(Meta):
	...
	# def load_workflows(self):
		...
		# workflow_docs = []
		# #workflow_name = "DSC Sales Invoice"
		# frappe.msgprint("load_workflows: " + str(self.name))
		# frappe.msgprint("load_workflows: " + str(workflow_name))
	...
	def load_workflows(self):
		...
		for workflow in workflows:
			if workflow.name and frappe.db.exists("Workflow", workflow.name):
				workflow = frappe.get_doc("Workflow", workflow.name)
				workflow_docs.append(workflow)
